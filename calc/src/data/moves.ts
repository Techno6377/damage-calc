...
const GSC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Dynamic Punch': {bp: 120, type: 'Fighting'},
  'False Swipe': {bp: 100, type: 'Normal'},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Volt Tackle': {bp: 140, type: 'Electric', recoil: [1, 3], makesContact: true},
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Dig: {bp: 120, category: 'Physical'},
  Dive: {bp: 120, category: 'Physical'},
  ...
  'Charge Beam': {bp: 60, type: 'Electric', category: 'Special'},
  'Close Combat': {
    bp: 120,
    type: 'Fighting',
    makesContact: true,
...
const SM_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Baddy Bad': {bp: 70, type: 'Dark', category: 'Special', zp: 175},
  ...
  'Freezy Frost': {bp: 70, type: 'Ice', category: 'Special', zp: 175},
  'Genesis Supernova': {
    bp: 185,
    type: 'Psychic',
    category: 'Special',
  ...
  'Glitzy Glow': {bp: 70, type: 'Psychic', category: 'Special', zp: 175},
  ...
  'Sappy Seed': {bp: 70, type: 'Grass', category: 'Physical', zp: 175},
  ...
  'Sparkly Swirl': {bp: 70, type: 'Fairy', category: 'Special', zp: 175},
...
const SV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Grassy Glide': {bp: 60, zp: 100, maxPower: 110},
  Gust: {isWind: true},
  ...
  'Mist Ball': {bp: 95, isPulse: true, zp: 175, maxPower: 130},
  ...
  'Energy Ball': {isPulse: true},
  'Flame Burst': {isPulse: true},
  'Precipice Blades': {isSlicing: true},
  'Pyro Ball': {isPulse: true},
  'Shadow Ball': {isPulse: true},
  'Smart Strike': {isSlicing: true},
  'Sludge Bomb': {isPulse: true},
  'Sucker Punch': {isPunch: true},
  'Weather Ball': {isPulse: true},
  'Aqua Cutter': {
    bp: 70,
    type: 'Water',
    category: 'Special',
